...
export const projects: Project[] = [
  {
    ...
    description: "A scalable financial management platform built with microservices architecture and event-driven communication.",
    ...
    techStack: ["NestJS", "Express", "Next.js", "Docker", "RabbitMQ", "Kong", "PostgreSQL", "MongoDB"],
  ...
  },
  {
    ...
    longDescription: "Database System with multiple view types (table, board, calendar, gallery), PARA Methodology Implementation, and event management. Supports multiple workspaces with custom properties (text, number, select, date-range, etc.).",
  ...
  },
  {
    ...
    longDescription: "Developed a reusable React library to simplify form state management and validation. Define comprehensive validation rules including required fields, patterns, and custom rules.",
  ...
  },
  {
    ...
    longDescription: "TechConnect is an employee management platform that helps organizations track employee performance, generate reports, and manage internal communication efficiently.",
